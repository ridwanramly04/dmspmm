...
export default {
    ...
    methods: {
        add: function(id) {
            ...
            axios.post('/staff/report/liability/add/'+id, form).then((data) => {
                this.lists(id)
            })
        },
        lists: function(id){

            axios.get('/staff/report/liability/'+id).then((data) => {
                this.assets = data.data.liability
            })
        ...
        {   
            ...
            axios.post('/staff/report/liability/delete/'+id, form).then((data)=> {
